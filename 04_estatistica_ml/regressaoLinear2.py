...
# Dados das variáveis 'joao' e 'maria' com informações sobre 'hospital', 'especialidade' e 'consulta/exame'
data = {
    'Paciente': ['joao', 'maria'],
...
new_data = {'Hospital': ['hospital'], 'Especialidade': ['especialidade'], 'Consulta': ['consulta'],'Exame':['exame']}
